...
public class Level2Screen implements Screen {
    ...
    public Level2Screen(Main main,SpriteBatch batch) {
        ...
        this.birdTexture = new Texture("bluebird.png");

        this.catapultTexture = new Texture("catapult.png");
        this.catapult = new Catapult(250, 300, 150, 100);
        ...
        this.bird = new Birds("bluebird", 10, 200, 300, 150, birdWidth,birdHeight);
    ...
    private void createGround() {
        ...
        groundDef.position.set(0, 300 / PIXELS_TO_METERS);

        groundBody = world.createBody(groundDef);

        PolygonShape groundShape = new PolygonShape();
        groundShape.setAsBox(Gdx.graphics.getWidth() / PIXELS_TO_METERS, 10 / PIXELS_TO_METERS);
    ...
    private void createBird() {
        ...
        birdDef.position.set(250 / PIXELS_TO_METERS, 500 / PIXELS_TO_METERS);
